...
Welcome to the TK Nuryanti GIMS documentation! This index will help you find the information you need.

## 📚 Getting Started

New to the project? Start here:

1. **[Main README](../README.md)** - Quick overview and setup
...
4. **[Project Analysis](./PROJECT_ANALYSIS.md)** - Complete project overview
...
3. [Database Guide](./DATABASE.md) - Data layer
4. [Quick Reference](./QUICK_REFERENCE.md) - Commands
5. [Contribution Guide](./CONTRIBUTION.md) - Best practices

### For DevOps/Deployment

1. [Deployment Guide](./DEPLOYMENT.md) - All deployment options
2. [Main README](../README.md) - Environment setup
3. [Architecture Guide](./ARCHITECTURE.md) → Deployment Architecture

### For Project Managers

1. [Project Analysis](./PROJECT_ANALYSIS.md) - Complete overview
2. [Improvements](./IMPROVEMENTS.md) - Enhancement roadmap
3. [README](./README.md) - Feature list

### For New Contributors

1. [Main README](../README.md) - Start here
2. [Contribution Guide](./CONTRIBUTION.md) - How to contribute
3. [Quick Reference](./QUICK_REFERENCE.md) - Common tasks
4. [Improvements](./IMPROVEMENTS.md) - Pick a task
